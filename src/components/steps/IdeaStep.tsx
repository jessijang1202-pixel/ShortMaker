          ...
          {preUploadedAssets.videoUrl ? (
            ...
            <button
              ...
              className={clsx(
                ...
                videoDrag
                  ? 'border-[var(--brand-primary)] bg-[var(--brand-soft-bg)] dark:bg-[var(--brand-soft-bg-dark)] text-[var(--brand-text)]'
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                    ...
                    <div className="flex items-start gap-1.5">
                      <Users className="w-3.5 h-3.5 text-[var(--brand-primary)] shrink-0 mt-0.5" />
                      <div>
